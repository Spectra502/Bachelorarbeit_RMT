...
def dataframeColumnSelectAndOrderByGroups(dataframeFSW, selectedLabel):
    ...
    dataframe_group_1 = dataframe[dataframe['Group'] == 1]
    dataframe_group_2 = dataframe[dataframe['Group'] == 2].reset_index(drop=True)
    dataframe_group_3 = dataframe[dataframe['Group'] == 3].reset_index(drop=True)
    dataframe_group_4 = dataframe[dataframe['Group'] == 4].reset_index(drop=True)
    dataframe_group_5 = dataframe[dataframe['Group'] == 5].reset_index(drop=True)
    dataframe_group_6 = dataframe[dataframe['Group'] == 6].reset_index(drop=True)
    dataframe_group_7 = dataframe[dataframe['Group'] == 7].reset_index(drop=True)

    dataframe_groups = {
        "group_1": dataframe_group_1,
        "group_2": dataframe_group_2,
        "group_3": dataframe_group_3,
        "group_4": dataframe_group_4,
        "group_5": dataframe_group_5,
        "group_6": dataframe_group_6,
        "group_7": dataframe_group_7
    }
